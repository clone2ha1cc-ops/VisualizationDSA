...
- **[07. Pseudocode Sync](./phase1-pseudocode-sync)** `✅ CODE DONE` — `PseudocodeSyncer.ts`, `PseudocodeViewer.vue` và tích hợp Monaco Editor thật
- **[08. Quiz System](./phase1-quiz-system)** `🟠 PARTIAL (~40%)` — `QuizEvaluationEngine.ts` có logic; UI chưa mount vào `App.vue`

### 🔵 PHÂN HỆ PHASE 2 (KỸ NGHỆ PHẦN MỀM & KIẾN TRÚC PHÂN TÁN)

> ⚠️ **Toàn bộ Phase 2 chưa có code. Tất cả là tài liệu đặc tả.**

- [09. Code to Visualization](./phase2-code-to-visualization) `❌ SPEC ONLY`
